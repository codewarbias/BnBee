...
const MyBookings = () => {
    ...
    // Function to cancel bookings Using API
            ...
            <div className=''>
                {bookings.map((item, index) => (
                    <div key={index} className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-4 border-b'>
                        <div>
                            <img className='w-36 bg-[#EAEFFF]' src={item.hotData.image} alt="" />
                        </div>
                        <div className='flex-1 text-sm text-[#5E5E5E]'>
                            <p className='text-[#262626] text-base font-semibold'>{item.hotData.name}</p>
                            <p>{item.hotData.location}</p>
                            <p className='text-[#464646] font-medium mt-1'>Address:</p>
                            <p className=''>{item.hotData.address.line1}</p>
                            <p className=''>{item.hotData.address.line2}</p>
